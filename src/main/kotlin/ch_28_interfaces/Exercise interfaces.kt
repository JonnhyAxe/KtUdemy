...
class Arabica: Coffee {
    override fun wakeUp() {
        println("Waking you up with some ch_28_interfaces.Arabica")
    }

    override fun quenchThirst() {
        println("Quenching your ch_28_interfaces.Arabica thirst")
    }
}

class Robusta: Coffee {
    override fun wakeUp() {
        println("ch_28_interfaces.Robusta will wake you up")
    }

    override fun quenchThirst() {
        println("ch_28_interfaces.Robusta will quench your thirst for coffee")
    }
}
